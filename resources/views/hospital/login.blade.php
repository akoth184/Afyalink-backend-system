...
<head>
    ...
    <title>Hospital Login — AfyaLink</title>
...
<div class="card">
    ...
    <p class="subtitle">Sign in to manage your facility</p>
    ...
    <div class="footer-link">
        New facility? <a href="{{ route('hospital.register') }}">Register your hospital</a>
    </div>
    <div class="footer-link">
