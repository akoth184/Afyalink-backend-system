...
<div class="stats-row">
<div class="stat-card"><div class="stat-top"><div class="stat-icon si-blue"><svg viewBox="0 0 24 24"><path d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414A1 1 0 0119 9.414V19a2 2 0 01-2 2z"/></svg></div><span class="stat-delta delta-up">Your records</span></div><span class="stat-num">{{ $stats['my_records'] ?? 0 }}</span><div class="stat-label">My Medical Records</div></div>
<div class="stat-card"><div class="stat-top"><div class="stat-icon si-amber"><svg viewBox="0 0 24 24"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg></div><span class="stat-delta delta-down">{{ $stats['my_referrals'] ?? 0 }} total</span></div><span class="stat-num">{{ $stats['my_referrals'] ?? 0 }}</span><div class="stat-label">My Referrals</div></div>
<div class="stat-card"><div class="stat-top"><div class="stat-icon si-green"><svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg></div></div><span class="stat-num">{{ $stats['total_hospitals'] ?? 0 }}</span><div class="stat-label">Available Hospitals</div></div>
<div class="stat-card"><div class="stat-top"><div class="stat-icon si-purple"><svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/></svg></div><span class="stat-delta delta-up">System-wide</span></div><span class="stat-num">{{ $stats['total_doctors'] ?? 0 }}</span><div class="stat-label">Total Doctors</div></div>
</div>
<div class="grid-main">
